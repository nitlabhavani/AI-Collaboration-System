      ...
      <div className="login-wrapper">
          ...
          <div className="illustration-content">
            <div className="illustration-icon">
              <svg viewBox="0 0 100 100" className="lock-svg">
                ...
                <rect x="30" y="40" width="40" height="35" rx="5" fill="url(#lockGrad)" />
                <path d="M35 40 V25 A15 15 0 0 1 65 25 V40" stroke="url(#lockGrad)" strokeWidth="6" fill="none" strokeLinecap="round" />
                <circle cx="50" cy="57" r="6" fill="white" />
                <rect x="48" y="57" width="4" height="8" fill="white" />
              </svg>
            </div>
            <h2>Welcome Back</h2>
        ...
        <div className="login-card">
          <div className="login-header">
            <div className="header-badge">Login</div>
